...
func (x *Command) GetRemoveServer() *RemoveServer {
	if x, ok := x.GetCmd().(*Command_RemoveServer); ok {
...
func (x *Command) GetRequestPreVote() *RequestPreVoteRequest {
	if x, ok := x.GetCmd().(*Command_RequestPreVote); ok {
		return x.RequestPreVote
	}
	return nil
}
...
type Command_RemoveServer struct {
	RemoveServer *RemoveServer `protobuf:"bytes,9,opt,name=remove_server,json=removeServer,proto3,oneof"`
}
...
type Command_RequestPreVote struct {
	RequestPreVote *RequestPreVoteRequest `protobuf:"bytes,10,opt,name=request_pre_vote,json=requestPreVote,proto3,oneof"`
}
...
func (*Command_RemoveServer) isCommand_Cmd() {}
...
func (*Command_RequestPreVote) isCommand_Cmd() {}
...
func (x *CommandResponse) GetRemoveServer() *RemoveServerResponse {
	if x, ok := x.GetResp().(*CommandResponse_RemoveServer); ok {
		return x.RemoveServer
	}
	return nil
}
...
func (x *CommandResponse) GetRequestPreVote() *RequestPreVoteResponse {
	if x, ok := x.GetResp().(*CommandResponse_RequestPreVote); ok {
		return x.RequestPreVote
	}
	return nil
}
...
type CommandResponse_RemoveServer struct {
	RemoveServer *RemoveServerResponse `protobuf:"bytes,9,opt,name=remove_server,json=removeServer,proto3,oneof"`
}
...
type CommandResponse_RequestPreVote struct {
	RequestPreVote *RequestPreVoteResponse `protobuf:"bytes,10,opt,name=request_pre_vote,json=requestPreVote,proto3,oneof"`
}
...
func (*CommandResponse_RemoveServer) isCommandResponse_Resp() {}
...
func (*CommandResponse_RequestPreVote) isCommandResponse_Resp() {}
...
type ResetCache struct {
	...
	// A random UUID to identify the reset. This is used to make sure that a reset is only done once
	// and applied to all nodes.
	Uuid string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	// hard requests an out-of-band hard reset: the receiving node tears down and rebuilds its raft on
	// fresh stores (dropping log, term, vote and snapshot) instead of forwarding a log-replicated soft
	// reset to the leader. Used to recover a cluster where a node is ahead of a freshly (re)started
	// leader and no leader can be elected (RT-13034).
	Hard bool `protobuf:"varint,2,opt,name=hard,proto3" json:"hard,omitempty"`
	// initiator_instance_id is the raft instance ID of the node initiating a hard reset. The receiving
	// follower adopts it while rebuilding its raft instead of clearing its own ID and waiting to
	// re-adopt one from a discovery ping of the leader: the wiped node is by construction joining the
	// initiator's consensus history, and discovery delivery is best-effort — a leader crash inside the
	// re-adoption window used to leave followers without an instance ID, disarming fork detection
	// (RT-13067). Empty when the initiator has no instance ID yet; the receiver then falls back to
	// clearing its own.
	InitiatorInstanceId string `protobuf:"bytes,3,opt,name=initiator_instance_id,json=initiatorInstanceId,proto3" json:"initiator_instance_id,omitempty"`
	// full requests a full reset: the FSM also clears stores that normally survive a reset (e.g.
	// flare's KeepOnReset, cache-only data with no source of truth to re-derive from). It is
	// independent of `hard`: a full reset is still log-replicated through the normal apply path and
	// triggers no raft reinit. Used by an explicit operator hard reset to wipe cache-only data, while
	// a no-leader auto-escalation leaves it false to preserve that data.
...
func (x *ResetCache) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *ResetCache) GetHard() bool {
	if x != nil {
		return x.Hard
	}
	return false
...
func (x *ResetCache) GetInitiatorInstanceId() string {
	if x != nil {
		return x.InitiatorInstanceId
	}
	return ""
}

func (x *ResetCache) GetFull() bool {
	if x != nil {
		return x.Full
	}
	return false
...
func (x *ResetCacheResponse) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
var file_v1_cmd_proto_rawDesc = []byte{
	...
	0x66, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xde, 0x04, 0x0a, 0x07, 0x43, 0x6f, 0x6d,
	...
	0x3e, 0x0a, 0x0d, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x71, 0x75, 0x61, 0x73, 0x61, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x48,
	0x00, 0x52, 0x0c, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	,
	...
	0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x68, 0x73, 0x70, 0x68, 0x69, 0x6e, 0x78, 0x2f, 0x71, 0x75, 0x61,
	0x73, 0x61, 0x72, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_v1_cmd_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_v1_cmd_proto_goTypes = []interface{}{
	...
	(*RemoveServer)(nil),            // 8: quasar.v1.RemoveServer
	(*RemoveServerResponse)(nil),    // 9: quasar.v1.RemoveServerResponse
	(*AppendEntriesRequest)(nil),    // 10: quasar.v1.AppendEntriesRequest
	(*RequestVoteRequest)(nil),      // 11: quasar.v1.RequestVoteRequest
	(*InstallSnapshotRequest)(nil),  // 12: quasar.v1.InstallSnapshotRequest
	(*TimeoutNowRequest)(nil),       // 13: quasar.v1.TimeoutNowRequest
	(*RequestPreVoteRequest)(nil),   // 14: quasar.v1.RequestPreVoteRequest
	(*AppendEntriesResponse)(nil),   // 15: quasar.v1.AppendEntriesResponse
	(*RequestVoteResponse)(nil),     // 16: quasar.v1.RequestVoteResponse
	(*InstallSnapshotResponse)(nil), // 17: quasar.v1.InstallSnapshotResponse
	(*TimeoutNowResponse)(nil),      // 18: quasar.v1.TimeoutNowResponse
	(*RequestPreVoteResponse)(nil),  // 19: quasar.v1.RequestPreVoteResponse
}
var file_v1_cmd_proto_depIdxs = []int32{
	...
	8,  // 3: quasar.v1.Command.remove_server:type_name -> quasar.v1.RemoveServer
	10, // 4: quasar.v1.Command.append_entries:type_name -> quasar.v1.AppendEntriesRequest
	11, // 5: quasar.v1.Command.request_vote:type_name -> quasar.v1.RequestVoteRequest
	12, // 6: quasar.v1.Command.install_snapshot:type_name -> quasar.v1.InstallSnapshotRequest
	13, // 7: quasar.v1.Command.timeout_now:type_name -> quasar.v1.TimeoutNowRequest
	14, // 8: quasar.v1.Command.request_pre_vote:type_name -> quasar.v1.RequestPreVoteRequest
	3,  // 9: quasar.v1.CommandResponse.store:type_name -> quasar.v1.StoreResponse
	5,  // 10: quasar.v1.CommandResponse.latest_uid:type_name -> quasar.v1.LatestUidResponse
	7,  // 11: quasar.v1.CommandResponse.reset_cache:type_name -> quasar.v1.ResetCacheResponse
	9,  // 12: quasar.v1.CommandResponse.remove_server:type_name -> quasar.v1.RemoveServerResponse
	15, // 13: quasar.v1.CommandResponse.append_entries:type_name -> quasar.v1.AppendEntriesResponse
	16, // 14: quasar.v1.CommandResponse.request_vote:type_name -> quasar.v1.RequestVoteResponse
	17, // 15: quasar.v1.CommandResponse.install_snapshot:type_name -> quasar.v1.InstallSnapshotResponse
	18, // 16: quasar.v1.CommandResponse.timeout_now:type_name -> quasar.v1.TimeoutNowResponse
	19, // 17: quasar.v1.CommandResponse.request_pre_vote:type_name -> quasar.v1.RequestPreVoteResponse
...
func file_v1_cmd_proto_init() {
	...
	file_v1_cmd_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*CommandResponse_RemoveServer)(nil),
		...
		(*CommandResponse_RequestPreVote)(nil),
	}
	type x struct{}
